...
void app_f034_send_ntf(uint8_t conidx,uint16_t len,uint8_t* buf)
{
    ...
    struct f030s_f0345_val_upd_req * req = KE_MSG_ALLOC(F030S_F034_VALUE_UPD_REQ,
                                                        prf_get_task_from_id(TASK_ID_F030S),
                                                        KE_BUILD_ID(TASK_APP, conidx),
                                                        f030s_f0345_val_upd_req);
...
{
    // Allocate the message
    struct f030s_f0345_val_upd_req * req = KE_MSG_ALLOC(F030S_F035_VALUE_UPD_REQ,
                                                        prf_get_task_from_id(TASK_ID_F030S),
                                                        KE_BUILD_ID(TASK_APP, conidx),
                                                        f030s_f0345_val_upd_req);
    // Fill in the parameter structure	
...
static int f030s_f034_val_ntf_cfg_ind_handler(ke_msg_id_t const msgid,
                                               struct f030s_f034_val_ntf_cfg_ind const *param,
                                               ke_task_id_t const dest_id,
                                               ke_task_id_t const src_id)
{
	uart_printf("f034->param->ntf_cfg = %x\r\n",param->ntf_cfg);
...
static int f030s_f035_val_ind_cfg_ind_handler(ke_msg_id_t const msgid,
                                               struct f030s_f035_val_ind_cfg_ind const *param,
                                               ke_task_id_t const dest_id,
                                               ke_task_id_t const src_id)
{
	uart_printf("f035->param->ind_cfg = %x\r\n",param->ind_cfg);
...
static int f034_val_upd_rsp_handler(ke_msg_id_t const msgid,
                                      struct f030s_f0345_val_upd_rsp const *param,
                                      ke_task_id_t const dest_id,
                                      ke_task_id_t const src_id)
{
...
static int f035_val_upd_rsp_handler(ke_msg_id_t const msgid,
                                      struct f030s_f0345_val_upd_rsp const *param,
                                      ke_task_id_t const dest_id,
                                      ke_task_id_t const src_id)
{
...
static int f032_writer_cmd_handler(ke_msg_id_t const msgid,
                                     struct f030s_f0323_writer_ind *param,
                                     ke_task_id_t const dest_id,
                                     ke_task_id_t const src_id)
{
    uint8_t buf[20];
    // Drop the message
	uart_printf("F032 conidx:%d,length:%d,param->value = 0x ",param->conidx,param->length);
    ...
    {
        app_f035_send_ind(param->conidx,20,buf);
    }
#if 0    
...
const struct ke_msg_handler app_f030_msg_handler_list[] =
{
    ...
    {F030S_F034_VALUE_NTF_CFG_IND,  (ke_msg_func_t)f030s_f034_val_ntf_cfg_ind_handler},
    {F030S_F035_VALUE_IND_CFG_IND,  (ke_msg_func_t)f030s_f035_val_ind_cfg_ind_handler},
    {F030S_F034_VALUE_UPD_RSP,      (ke_msg_func_t)f034_val_upd_rsp_handler},
    {F030S_F035_VALUE_UPD_RSP,      (ke_msg_func_t)f035_val_upd_rsp_handler},
    {F030S_F032_WRITER_CMD_IND,		(ke_msg_func_t)f032_writer_cmd_handler},
